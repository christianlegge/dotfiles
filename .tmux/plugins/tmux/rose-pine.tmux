...
main() {
    ...
    show_window_in_window_status="#[fg=$thm_base,bg=$thm_base] #[fg=$thm_iris]#I#[fg=$thm_iris,] #[fg=$thm_iris]#W #[fg=$thm_base,bg=$thm_base]"

    local show_window_in_window_status_current
    show_window_in_window_status_current=" #I#[fg=$thm_gold,bg=""] #[fg=$thm_gold,bg=""]#W #[bg=$thm_base,fg=$thm_gold]"
    ...
    # We set the sections
    set status-left "$spacer#[fg=$thm_subtle]$current_folder_icon #[fg=$thm_iris]#{b:pane_current_path} "
